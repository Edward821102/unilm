...
def main():
    ...
    if data_args.dataset_name == 'electronic':
        import layoutlmft.data.electronic
        datasets = load_dataset(os.path.abspath(layoutlmft.data.electronic.__file__), cache_dir=model_args.cache_dir)
    else:
    ...
    if training_args.do_predict:
        ...
        if trainer.is_world_process_zero():
            with open(f"/home/edward/桌面/{output_test_predictions_file}", "w") as writer:
